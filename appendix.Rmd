...
## How are institutions distributed amongst cantons?
The following code orders the cantons in terms of the proportion of private isntitutions. It then divides the cantons across 20 quantiles. Finally, it then calculates the average proportion per quantile and graphs it. 
...
dfcant1 <- dfcant %>%
        ...
        arrange(private) %>%
        mutate(quantile = ntile(private, 20)) %>%
        group_by(quantile) %>%
