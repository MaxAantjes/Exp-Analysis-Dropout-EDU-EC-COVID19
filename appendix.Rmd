...
p3 <- p2 + theme(axis.text.x = element_text(angle = 90)) + labs(
  ...
  subtitle = "Cantons with private education enrolment < 0% removed.", 
  caption = "AMIE Data collected by INEC (2019)\nData Summary by Max Aantjes")
p3
