...
p2 <- p1 + theme_bw() + labs(title = "Median Teacher Student Ratio", y = "")
p2

p <- ggplot(dat = dfprov1 %>% filter(province == "total"), aes(x = year, y = sum.students/1000000, col = type))
p1 <- p + geom_point() + geom_line()
p2 <- p1 + theme_bw() + labs(title = "Total Students Enrolled (in millions)", y = "")
p2

p <- ggplot(dat = dfprov1 %>% filter(province == "total"), aes(x = year, y = sum.teachers/1000, col = type))
p1 <- p + geom_point() + geom_line()
p2 <- p1 + theme_bw() + labs(title = "Total Teachers Enrolled (in thousands)", y = "")
p2
```
